...
public interface FilterConst {
    ...
    String LOAD_BALANCE_CONSISTENT = "consistent";
    ...
    String BASIC_AUTH_FILTER_ID = "basic_auth_filter";
    String BASIC_AUTH_FILTER_NAME = "basic_auth_filter";
    int BASIC_AUTH_FILTER_ORDER = 1;
